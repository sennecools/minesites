  ...
  return (
    <>
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="font-display text-2xl font-bold tracking-tight text-zinc-900">Welcome back</h1>
        <p className="mt-2 text-sm text-zinc-500">Sign in to continue building</p>
      </div>
      ...
      {/* Email/Password Form */}
      <form onSubmit={handleCredentialsSubmit} className="space-y-4" autoComplete="on">
        <AnimatePresence>
          {error && (
            <motion.div
