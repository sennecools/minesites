...
**Paid-tier unlocks (or v1 stretch):** 8. **Staff** — Team member cards with skin avatar, username, and role. 9. **News / Announcements** — Card feed of updates. Title, date, short description. 10. **Custom CTA / Countdown** — Generic call-to-action or season countdown timer.
